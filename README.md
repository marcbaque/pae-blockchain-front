...
This seed repo serves as an Angular 5 webapp starter
* Best practices in file and application organization for Angular by John Papa oficial guidelines.
...
* Testing Angular 5 code with Jasmine and Karma.
* Coverage with Istanbul and Karma
* End-to-end Angular 5 code using Protractor.
...
## Running the app
After you have installed all dependencies you can now run the app. Run `npm run server` to start a local server using `webpack-dev-server` which will watch, build (in-memory), and reload for you. The port will be displayed to you as `http://0.0.0.0:5073` (or if you prefer IPv6, if you're using `express` server, then it's `http://[::1]:5073/`).
...
The included `.vscode` automatically connects to the webpack development server on port `5073`.
